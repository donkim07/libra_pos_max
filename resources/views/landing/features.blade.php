...
@section('content')
    <section class="border-b border-slate-800 bg-grid">
        <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
            ...
            <p class="mt-4 max-w-3xl text-lg text-slate-300">Every module is designed to keep your team aligned from raw
                materials to final sale, without operational blind spots.</p>
        </div>
    </section>
    ...
    <section class="mx-auto max-w-7xl space-y-16 px-4 py-16 sm:px-6 lg:px-8">
        <article class="grid items-center gap-10 lg:grid-cols-2">
            ...
            <div class="rounded-2xl border border-slate-800 bg-slate-800 p-3">
                <div class="h-54 rounded-lg bg-slate-200">
                    <img src="{{ asset('images/features/manufacturing.png') }}" alt="Manufacturing Management"
        ...
        <article class="grid items-center gap-10 lg:grid-cols-2">
            <div class="order-2 lg:order-1 rounded-2xl border border-slate-800 bg-slate-800 p-3">
                <div class="h-54 rounded-lg bg-slate-200">
                    <img src="{{ asset('images/features/inventory.png') }}" alt="Inventory & Warehousing"
                        class="w-full h-full object-cover">
                </div>
            </div>
        ...
        <article class="grid items-center gap-10 lg:grid-cols-2">
            ...
            <div class="rounded-2xl border border-slate-800 bg-slate-800 p-3">
                <div class="h-54 rounded-lg bg-slate-200">
                    <img src="{{ asset('images/features/sales-invoicing.png') }}" alt="Sales & Invoicing"
                        class="w-full h-full object-cover">
                </div>
            </div>
        </article>
        ...
        <article class="grid items-center gap-10 lg:grid-cols-2">
            <div class="order-2 lg:order-1 rounded-2xl border border-slate-800 bg-slate-800 p-3">
                <div class="h-54 rounded-lg bg-slate-200">
                    <img src="{{ asset('images/features/business-intelligence.png') }}" alt="Business Intelligence"
                        class="w-full h-full object-cover">
                </div>
            </div>
            <div class="order-1 lg:order-2">
    ...
    <section class="border-t border-slate-800 bg-slate-900 py-16">
        <div class="mx-auto max-w-4xl px-4 text-center sm:px-6">
            ...
            <p class="mt-3 text-slate-300">From factory floor to cashier desk, LibraPOS gives one source of truth for your
                business.</p>
            <a href="/admin/login"
                class="mt-7 inline-block rounded-lg bg-amber-500 px-6 py-3 font-bold text-slate-950 hover:bg-amber-400">Start
                Free Trial</a>
        </div>
    </section>
@endsection
